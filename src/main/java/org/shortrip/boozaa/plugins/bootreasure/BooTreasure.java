...
public class BooTreasure  extends JavaPlugin{
	...
	@Getter private static Configuration mainConfig;
	@Getter private static Configuration messagesConfig;
	@Getter private static Configuration treasuresConfig;
	...
	public void onEnable() {
			...
			try {
				...
				if( treasuresConfig.get("treasures") == null ) {
					...
					treasuresConfig.set("treasures.49b64cb2-79e6-4ee6-8eb8-2fdd614fabc3.basics.cronpattern", "*/1 * * * *");
