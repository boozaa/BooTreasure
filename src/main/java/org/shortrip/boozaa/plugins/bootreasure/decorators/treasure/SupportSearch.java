...
public class SupportSearch {
	...
	@Synchronized
	public static Block findGoodBlock(Treasure treasure){
		...
		if( treasure.get_onlyonsurface() && treasure.get_allowedids().isEmpty() ){
		...
		if( treasure.get_onlyonsurface() && !treasure.get_allowedids().isEmpty() ){
			return findGoodSpawn(world, treasure.get_allowedids(), true);
		}
		...
		if( !treasure.get_onlyonsurface() && !treasure.get_allowedids().isEmpty() ){
			return findGoodSpawn(world, treasure.get_allowedids(), false);
		}
